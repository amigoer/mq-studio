...
export const zh: Content = {
  ...
  meta: {
    ...
    description:
      'MQ Studio 是本地优先的消息队列桌面客户端，RocketMQ、RabbitMQ、Kafka、Pulsar、Redis Stream、MQTT 与 NATS 共用同一套界面和操作，无需部署和值守 Web 控制台。支持 macOS、Windows、Linux，Apache-2.0 开源。',
  ...
  drivers: {
    ...
    planned: '计划中：ActiveMQ · Amazon SQS · Google Cloud Pub/Sub 等',
  },
  features: {
