...
function severityIcon(s: AlertSeverity) {
  ...
  if (s === "warn")
    return <AlertTriangle size={13} style={{ color: "hsl(var(--warning))" }} />;
      ...
      {alerts.map((a, i) => (
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="text-muted-foreground mt-0.5 text-fs-115 leading-snug">
              {a.desc}
            </div>
          </div>
          {a.since && (
...
function RulesPanel({
  ...
  return (
    <Card style={{ padding: 20 }}>
      ...
      <div
        className="text-muted-foreground mt-2 text-fs-11"
        style={{ lineHeight: 1.5 }}
      >
      ...
      >
        ...
        >
          <div className="text-muted-foreground text-fs-12">
            {t("alerts.rules.lagThreshold")}
          </div>
          <div className="tabular-nums mt-1 text-fs-18 font-semibold">
            {lagThreshold <= 0
              ? t("alerts.rules.thresholdOff")
              : t("alerts.rules.lagThresholdValue", {
                  n: lagThreshold.toLocaleString(),
                })}
          </div>
        </div>
        <div
          ...
          return (
            ...
            >
              ...
              <Switch
                ...
                title={
                  on ? t("alerts.rules.enabled") : t("alerts.rules.disabled")
                }
              />
            </div>
          );
