...
export function AppLogo({ width = 32, height = 22 }: { width?: number; height?: number }) {
  return (
    <svg width={width} height={height} viewBox="0 0 140 96" style={{ flex: "none", color: "var(--c-logo-ink)" }} aria-hidden>
      <path
        ...
        strokeWidth="10"
      />
      <circle cx="98" cy="50" r="24" fill="none" stroke="currentColor" strokeWidth="10" />
