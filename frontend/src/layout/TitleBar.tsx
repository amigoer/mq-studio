...
export function TitleBar({
  ...
  return (
    <>
      <header
        className={cn(
          "mqs-title-bar app-region-drag",
          !mac && "mqs-title-bar--win",
        )}
      >
        ...
        <div className="conn-menu-wrap app-region-no-drag" ref={menuRef}>
          <button
            ...
            title={
              online
                ? t("titlebar.connectedHint", { name: connected })
          ...
          >
            ...
            <span className="conn-name">
              {online ? connected : t("titlebar.noCluster")}
            </span>
            <ChevronDown
              size={12}
              className={cn("conn-chevron", menuOpen && "open")}
              aria-hidden
            />
          </button>
          ...
          {menuOpen && (
            <div className="conn-menu" role="menu">
              <div className="conn-menu-label">
                {t("titlebar.switchConnection")}
              </div>
              {list.length === 0 ? (
                <div className="conn-menu-empty">
                  {t("titlebar.noConnections")}
                </div>
              ) : (
                list.map((c) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className={cn("item-dot", isOnline ? "on" : "off")}
                        aria-hidden
                      />
        ...
        {!mac && (
          <div className="app-region-no-drag flex shrink-0 items-center gap-0.5">
            ...
            <button
              ...
              aria-label={
                isMaximised ? t("common.restore") : t("common.maximize")
              }
            >
              {isMaximised ? (
