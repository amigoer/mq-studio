...
export const getBrokers = (): Promise<BrokerNode[]> => ClusterService.Brokers(ACTIVE_CONNECTION).then(present)
export const getClusterInfo = (): Promise<ClusterInfo> => ClusterService.Info(ACTIVE_CONNECTION).then(required)
